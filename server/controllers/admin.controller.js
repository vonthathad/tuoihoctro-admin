...
export function register(req, res) {
  ...
  if (!req.admin) {
    ...
    admin.displayName = req.body.username;
...
export function get(req, res) {
  res.json({ data: req.selectedAdmin });
}
...
export function update(req, res) {
  ...
  Admin.findByIdAndUpdate(req.selectedAdmin._id, req.selectedAdmin, '-password -salt -token -isVerified -providerData').exec((err, admin) => {
    if (err) {
